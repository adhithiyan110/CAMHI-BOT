...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('rbot_description')
    
    
    nav2_yaml = os.path.join(get_package_share_directory('rbot_description'), 'config', 'nav2_params.yaml')
    map_file = os.path.join(get_package_share_directory('rbot_description'), 'maps', 'my_map.yaml')
